...
Legend: `[x]` shipped, `[ ]` planned. This roadmap is derived from the product spec (`tz_ai_design_service.md`) and reflects what is actually in the repository today, separated from what is still on the drawing board.
