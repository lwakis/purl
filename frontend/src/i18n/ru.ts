...
export const ru = {
  ...
  chat: {
    ...
    model: 'Модель',
    modelSoon: 'Выбор модели скоро появится',
    mode: 'Режим',
    modeSoon: 'Режимы скоро появятся',
    plan: 'План',
    planSoon: 'Режим «План» скоро появится',
    copy: 'Копировать',
    copied: 'Скопировано',
    like: 'Нравится',
    dislike: 'Не нравится',
  ...
  topbar: {
    ...
    code: 'Код',
    settings: 'Настройки',
    settingsSoon: 'Настройки скоро появятся',
    commandPlaceholder: 'Введите команду…',
    commandSoon: 'Команды скоро появятся',
    ...
    help: 'Справка',
    helpSoon: 'Справка скоро появится',
