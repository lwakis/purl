...
export const en: RuDictionary = {
  ...
  chat: {
    ...
    attachSoon: 'Attachments are coming soon',
    model: 'Model',
    modelSoon: 'Model selection is coming soon',
    mode: 'Mode',
    modeSoon: 'Modes are coming soon',
    plan: 'Plan',
    planSoon: 'Plan mode is coming soon',
    copy: 'Copy',
    copied: 'Copied',
    like: 'Like',
    dislike: 'Dislike',
  ...
  topbar: {
    ...
    commandSoon: 'Commands are coming soon',
